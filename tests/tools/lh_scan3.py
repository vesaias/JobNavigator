...
ROUTES = [
    ...
    ('resumes', '/resumes', None),
    ('resume-editor', '/resumes/22ce0e5b-8b9b-4ea5-b34a-b9b6f9e3a51a', 'expand'),
    ('cover-letters', '/cover-letters', None),
    ('persona', '/persona', 'persona'),
    ('stats', '/stats', None),
    ('settings', '/settings', None),
]
if cl_id:
    ROUTES.insert(7, ('cover-letter-editor', '/cover-letters/' + str(cl_id), None))
