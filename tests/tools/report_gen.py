...
files = sorted(glob.glob("tests/stage3/*.md")) + ["tests/FINDINGS.md", "tests/stage5/cross-cutting.md"]
for f in files:
...
cant = []
for f in sorted(glob.glob("tests/stage3/*.md")):
