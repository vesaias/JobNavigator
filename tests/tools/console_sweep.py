...
ROUTES = [
    ("v2-feed", "/feed"), ("v2-feed-job", f"/feed?job={jid}"),
    ("v2-searches", "/searches"), ("v2-companies", "/companies"),
    ("v2-applications", "/applications"), ("v2-resumes", "/resumes"),
    ("v2-resume-editor", f"/resumes/{rid}"), ("v2-cover-letters", "/cover-letters"),
    ("v2-cover-letter-editor", f"/cover-letters/{clid}"), ("v2-persona", "/persona"),
    ("v2-stats", "/stats"), ("v2-settings", "/settings"), ("v2-toasts", "/toasts"),
    ("v2-root", "/"),
    ("v1-feed", "/classic"), ("v1-applications", "/classic/applications"), ("v1-companies", "/classic/companies"),
    ("v1-searches", "/classic/searches"), ("v1-settings", "/classic/settings"), ("v1-resumes", "/classic/resumes"),
    ("v1-cover-letters", "/classic/cover-letters"), ("v1-persona", "/classic/persona"), ("v1-stats", "/classic/stats"),
]
...
with sync_playwright() as p:
    ...
    for appearance in ("light", "dark"):
        ...
        """)
        warm = ctx.new_page(); warm.goto(BASE + "/feed", wait_until="networkidle"); warm.wait_for_timeout(800); warm.close()
