...
**Status** fixed (a, d) + decided keep (b, c, e), verified after rebuild: no hover on the Funnel/Flow, period and Type ▾ pills; the running Run button reads "Running…" in `--edge`. (b), (c), (e) decided keep
