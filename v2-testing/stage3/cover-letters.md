...
**Status** decided 2026-09-02: keep all except (d); contact rows in the cover-letter, résumé and persona editors now split 45/55 — controls + Display text on the left, URL + stub (+ ✕) on the right, controls and stub at their previous widths (measured 226/277 in both résumé editors, 251/307 on Persona)
