"""Jobright.ai job scraper — personalized recommendations + search via REST API."""
import asyncio
import json
import logging
import re
...
async def scrape_jobright(search: Search) -> dict:
...
async def test_jobright(search, db) -> dict:
