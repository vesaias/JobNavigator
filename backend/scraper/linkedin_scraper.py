"""LinkedIn personal job scraper — recommended + top-applicant collections."""
import asyncio
import json
import logging
import os
...
async def _get_linkedin_browser():
    ...
    from backend.scraper.playwright_scraper import _STEALTH_ARGS, _USER_AGENT
...
async def scrape_linkedin_personal(search: Search) -> dict:
...
async def test_linkedin_personal(search, db) -> dict:
