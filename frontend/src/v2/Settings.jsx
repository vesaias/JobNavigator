  ...
  const sections = useMemo(() => {
    ...
    return [
      ...
      ['scheduler', 'PIPELINE', 'Scheduler', 'intervals in minutes (0 = off) · crons are min hour day month dow, empty = off', [
        ...
        B('Cleanup after', 'Days before unsaved postings are purged.', 'job_archive_after_days', { mono: true, w: '135px' }),
        B('Auto-reject after', 'Days of silence before an application is auto-moved to Rejected.', 'auto_reject_after_days', { mono: true, w: '135px',
        ...
        B('DB backup · cron', 'Nightly database snapshot.', 'backup_cron', { mono: true, w: '135px' }),
        B('Telegram digest · cron', 'Morning summary of new high-fit jobs.', 'digest_cron', { mono: true, w: '135px' }),
        B('H-1B refresh · cron', 'Re-imports the sponsorship dataset.', 'h1b_cron', { mono: true, w: '135px' }),
      ...
      ['notifications', 'INTEGRATIONS', 'Notifications', 'Telegram bot · digest schedule lives under Scheduler', [
        ...
        B('Score threshold', 'Only jobs scoring at or above this trigger an instant alert — everything else waits for the digest.', 'fit_score_threshold', { mono: true, w: '135px' }),
